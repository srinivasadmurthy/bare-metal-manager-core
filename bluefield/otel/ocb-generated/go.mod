...
require (
	...
	puntstatsreceiver v0.0.1
	telemetrystatsprocessor v0.0.1
)
...
replace fileresourceprocessor => ../fileresourceprocessor

replace telemetrystatsprocessor => ../telemetrystatsprocessor

replace puntstatsreceiver => ../puntstatsreceiver
