---
tags: ["maintenance", "database", "deployment", "dpu", "machine-identity", "multi-arch", "networking", "ntp", "rest-api", "security", "telemetry", "validation", "zero-dpu"]
---

## NVIDIA Infra Controller v2.0 <Badge intent="warning">Maintenance</Badge>
